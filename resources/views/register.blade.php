                ...
                <div class="row w-100">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" id="register_form" method="POST" action="{{ route('api.register') }}">
                                @csrf
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    <a href="{{route('login')}}" class="auth-link text-black">Sign In?</a>
                                </div>
                            </form>
                        </div>
                    </div>
